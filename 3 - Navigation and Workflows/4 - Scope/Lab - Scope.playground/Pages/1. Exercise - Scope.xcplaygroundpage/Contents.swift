...
//print("The value of foo is \(foo)")
//The 10th line generates a compiler error as foo is declared inside the for loop and is out of scope for the print statement
...
// it uses x from outside scope, the same variable then modified inside the function, and foo was defined in outer scope
