...
let favoriteBook = Book(title: "Hunger Games", author: "Suzanne Collins", pages: 350, price: 15.5)
print("The book \(favoriteBook.title) by \(favoriteBook.author) costs $\(favoriteBook.price) and has \(favoriteBook.pages) pages")
/*:
...
let hpLaptop = Laptop(type: 2, yearPurchased: 2020)
let macbookPro = Laptop(type: 3, yearPurchased: 2021)
