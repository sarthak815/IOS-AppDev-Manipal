...
struct User {
    ...
    static var currentUser = User(userName: "sarthaks", email: "sarthak.shastri@gmail.com", age: 23)
 ...
 */
User.logIn(user: User(userName: "sarthaks", email: "sarthak.shastri@gmail.com", age: 21))
