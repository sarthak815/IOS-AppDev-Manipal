...
let heartRate2 = 74
let heartRate3 = 90
let addedHR = heartRate2+heartRate3+heartRate1
...
print(averageHRD)
print("The answer will vary as in the case of values being taken as double the final output will be in double form as well")
...
print("The goal achieved till now:", String(percentOfGoal))
/*:
