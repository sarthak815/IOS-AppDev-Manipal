...
print("This code compiles because the schooling integer was declared as a variable which allows its value to be updated whenever needed, whereas in the previous case the integer was declared as a constant.")
